          ...
          <el-col :span="24">
            <div style="width: 100%;height: auto">
              <div class="course-top">
                <div class="top-title">个人精品资源管理</div>
              </div>
              <div class="course-select">
                <el-input clearable @keyup.enter.native="init" v-model="list_data.title" placeholder="请输入资源标题"></el-input>
              ...
              <el-table :data="tableData" border v-loading="loading" style="width: 100%">
                ...
                <!-- <el-table-column label="审核状态" width="100" align="center">
                  <template slot-scope="scope">
                    ...
                    <span v-if="scope.row.check_state === 1" class="success-state">已通过</span>
                    <span v-if="scope.row.check_state === 2" class="back-state">退回</span>
                  </template>
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    init() {
      this.loading = true;
      this.api.getnombtqress(this.init_data, this.list_data).then(res => {
        this.loading = false;
    ...
    handleEdit(index, id) {
      this.$router.push("/assess/checked/" + id);
    },
    //删除
