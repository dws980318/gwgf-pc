<template>
  ...
  <el-row :span="24" style="background-color: #f2f2f2;">
    ...
    <div class="container" style="font-size: 12px;background-color: #fff;">
      <el-col :span="24" style=" margin-bottom: 50px;min-height: 730px;background-color: #fff">
        <el-tabs style="padding: 0 20px;" v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="个人精品资源管理" name="/assess/checked"></el-tab-pane>
          <el-tab-pane label="全部精品资源管理" name="/assess/unchecked"></el-tab-pane>
        </el-tabs>
...
export default {
  ...
  data() {
    return {
      loading: false,
      activeName: "/assess/checked/list",
    };
  },
  created() {
