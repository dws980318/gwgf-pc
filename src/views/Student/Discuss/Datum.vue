<template>
  ...
  <div class="datum">
    <div class="datum-top">
      <div class="top-title">学习资料</div>
    </div>
    <div class="datum-select">
    ...
    <div class="dataTable_main">
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="name" label="文件名" width="180" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="date" label="上传时间" width="180" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="date2" label="类型" width="180" align="center" show-overflow-tooltip></el-table-column>
...
.datum /deep/ .el-pagination.is-background .el-pager li:hover {
  color: #617fa5;
}
.datum
  /deep/
