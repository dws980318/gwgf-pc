...
<template>
  ...
  <div style="padding: 20px;">
    ...
    <div v-if="activeName === 'teacher'">
      <div class="teaEvaluate" v-for="item in form">
        ...
        <div class="schoolmate">
          ...
          <div class="theme-bottom">
            <div style="min-height: 40px;padding-top: 15px;padding-bottom: 15px;">{{item.remark}}</div>
            <div>
              <p>
    ...
    <div v-else>
      <div class="stuEvaluate" v-for="item in form">
        ...
        <!-- <div class="schoolmate">
          <div class="stuEvaluate-title">同学互评</div>
          <div class="theme-bottom" v-for="(item, index) in tabData" :key="index">
            <div style="min-height: 40px;padding-top: 15px;padding-bottom: 15px;">{{form.remark}}</div>
            <div>
              <p>
