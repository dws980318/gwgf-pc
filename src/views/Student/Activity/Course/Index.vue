                ...
                <el-col :span="24">
                  <div style="width: 100%;height: auto">
                    <div class="course-top">
                      <div class="top-title" @click="addAction">活动管理</div>
                    </div>
                    <div class="course-select">
                      <el-input
                        ...
                        v-model="list_data.activityName"
                        placeholder="请输入活动名称"
                      ></el-input>
                      <el-date-picker
                  ...
                  <div class="table">
                    ...
                    >
                      ...
                      <el-table-column label="报名状态" prop="activityType" width="100" align="center">
                        <template slot-scope="scope">
                          ...
                          <!-- <span class="success-state">{{scope.row.activityType}}</span> -->
                        </template>
                      </el-table-column>
...
export default {
  ...
  computed: {},
  created() {
    this.selectIndex = localStorage.selectIndex ? localStorage.selectIndex : 0;
    this.hoverIndex = localStorage.selectIndex ? localStorage.selectIndex : 0;
    this.list_data.activityType = parseInt(localStorage.activityType);
    this.hoverTop =
      (localStorage.selectIndex ? localStorage.selectIndex : 0) * 46;
    this.init();
  ...
  methods: {
    ...
    navAction(id, index) {
      ...
      localStorage.activityType = parseInt(id);
      this.list_data.activityType = parseInt(id);
      this.init();
    },
    //报名
    ...
    handleDelete(index, row) {
      this.api.del_activity({ ids: row }).then(res => {
        if (res.status === 200) {
          this.$message.success(res.message);
