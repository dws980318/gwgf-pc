...
export default {
  ...
  computed: {},
  created() {
    this.selectIndex = parseInt(localStorage.btrIndex)? parseInt(localStorage.btrIndex) : 0
    this.hoverIndex = parseInt(localStorage.btrIndex) ? parseInt(localStorage.btrIndex) : 0;
