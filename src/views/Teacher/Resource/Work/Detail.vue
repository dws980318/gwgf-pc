<template>
  ...
  <div class="homework">
    <div class="container">
      <el-page-header @back="goBack" content="学生作业"></el-page-header>
      <div class="homework-select">
        <el-input clearable @keyup.enter.native="init" v-model="list_data.issuer_name" placeholder="请输入学生名称"></el-input>
