            ...
            <div class="details" style="min-height: 730px;background-color: #fff;">
                ...
                <div class="title">
                    ...
                    <div class="message">
                        ...
                        <div class="btn">
                            <el-button v-if="show" @click="deleteAction" style="color: #fff;;background: red;">删除</el-button>
        ...
        methods: {
            ...
            getLeafCountTree(data) {
                if (!data.rList) {
                    ...
                    //   // console.log(data.rList[i]);
                    //   this.getLeafCountTree(data.rList[i]);
                    //   // console.log(this.getLeafCountTree(data.rList[i]))
                    //   this.leafCount.push(data.rList[i]);
                    // }
