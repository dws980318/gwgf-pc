...
<template>
  <div class="courseDetails">
      <div class="details">
        <el-page-header @back="goBack" :content="$route.params.id ? '编辑课外活动' : '新增课外活动'"></el-page-header>
        <div class="form">
          <el-form ref="checkForm" :model="form" label-width="150px">
            ...
            <el-form-item label="正文">
              <el-input type="textarea" rows="5" v-model="form.textarea" placeholder="请输入正文内容"></el-input>
            </el-form-item>
